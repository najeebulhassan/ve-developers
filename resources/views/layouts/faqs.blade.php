        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="img-faqs w-100">
                    <div class="img mb-4 mb-sm-0" style="background-image:url(public/assets/ved/faqs-1.jpg);">
                    </div>
                    <div class="img img-2 mb-4 mb-sm-0" style="background-image:url(public/assets/ved/faqs-2.png);">
                    </div>
                </div>
            </div>
