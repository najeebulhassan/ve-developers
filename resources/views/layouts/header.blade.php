<head>
    ...
    <script src="public/assets/js/splide.js"></script>
...
<body>
                            ...
                            <div class="row">
                                <div class="col-md-6 d-flex align-items-center">
                                    <p class="mb-0 phone pl-md-2">
                                        <a href="#" class="mr-2" style="color: black;"><span class="fa fa-phone mr-1" style="color: black;"></span> 0020-3813-0607</a>
                                        <a href="#" style="color: black;"><span class="fa fa-paper-plane mr-1" style="color: black;"></span> info@vedevelopers.com</a>
                                    </p>
                                </div>
                                <div class="col-md-6 d-flex justify-content-md-end">
                                    <div class="social-media">
                                        <p class="mb-0 d-flex">
                                            <a href="https://web.facebook.com/Virtual-Eye-Developers-VED-100648261868593" class="d-flex align-items-center justify-content-center"><span class="fa fa-facebook" style="color: black;"><i class="sr-only">Facebook</i></span></a>
                                            <!-- <a href="#" class="d-flex align-items-center justify-content-center"><span class="fa fa-twitter" style="color: black;"><i class="sr-only">Twitter</i></span></a> -->
                                            <a href="https://www.linkedin.com/company/virtual-eye-developers-ved" class="d-flex align-items-center justify-content-center"><span class="fab fa-linkedin" style="color: black;"></span><i class="sr-only">Linkedin</i></span></a>
                                        </p>
                                    </div>
                                </div>
                            </div>
    ...
    <div id="header-2" class="fixed-top">
        <div class="wrap" style="z-index: 100; position:absolute; background: #FFFFFF;">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="bg-wrap">
