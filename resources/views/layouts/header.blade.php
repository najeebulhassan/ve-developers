...
<body>
    ...
    <div id = "header-1" class="fixed-top">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 d-flex justify-content-md-end">
                                    <div class="social-media">
                                        <p class="mb-0 d-flex">
                                            <a href="#" class="d-flex align-items-center justify-content-center"><span class="fa fa-facebook" style="color: black;"><i class="sr-only">Facebook</i></span></a>
                                            ...
                                            <a href="#" class="d-flex align-items-center justify-content-center"><span class="fab fa-linkedin" style="color: black;"></span><i class="sr-only">Linkedin</i></span></a>
                                        </p>
                                    </div>
                                </div>
                            </div>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar" style="position: absolute; top: 45px; left:80px; z-index: 100;">
            <div class="container">
